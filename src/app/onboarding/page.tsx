...
export default function OhrlyEcommerceChecklistDownloadFirst() {
  ...
  return (
    <main className="min-h-screen bg-[#fbf9ff] text-slate-950">
      <section className="mx-auto grid min-h-screen w-full max-w-6xl items-center gap-10 px-4 py-8 sm:px-6 lg:grid-cols-[1fr_0.92fr] lg:px-8">
